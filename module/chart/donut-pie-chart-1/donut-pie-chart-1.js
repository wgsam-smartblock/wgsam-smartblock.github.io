...
(function (doc, win) {
    ...
    var donutty = win.Donutty = function (el, options) {
        ...
        _this.options.radius = float(_this.options.radius) || 100;
    ...
    donutty.prototype.createFragments = function () {
        ...
        var namespace = "http://www.w3.org/2000/svg",
            ...
            rotate = this.options.circle ? 90 + rotateExtra : -238;
        ...
        this.$svg.style.webkitTransform = "rotate(-238deg)";
        ...
        // color for diffrent range
        if (this.state.value < 30) {
            this.state.color = "lightcoral";
            this.$donut.setAttribute("stroke", this.state.color);
        } else if (this.state.value >= 30 && this.state.value < 50) {
            this.state.color = "orchid";
            this.$donut.setAttribute("stroke", this.state.color);
        } else if (this.state.value >= 50 && this.state.value < 70) {
            this.state.color = "gold";
            this.$donut.setAttribute("stroke", this.state.color);
        } else if (this.state.value >= 70 && this.state.value < 90) {
            this.state.color = "mediumslateblue";
            this.$donut.setAttribute("stroke", this.state.color);
        } else if (this.state.value >= 90) {
            this.state.color = "aquamarine";
            this.$donut.setAttribute("stroke", this.state.color);
        }
    ...
    donutty.prototype.getDashValues = function () {
        ...
        multiplier = this.options.circle ? 1 : 0.82;
